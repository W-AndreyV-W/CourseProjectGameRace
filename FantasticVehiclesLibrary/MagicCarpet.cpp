...
MagicCarpet::MagicCarpet(float distance_race, std::string name_vehicles, float speed_vehicles, float coefficient, float coefficient_1000, float coefficient_5000, float coefficient_10000) :Air(distance_race, name_vehicles, speed_vehicles, coefficient) {
