...
public:
	...
	~MagicCarpet();
protected:
	MagicCarpet(float distance_race, std::string name_vehicles, float speed_vehicles, float coefficient, float coefficient_1000, float coefficient_5000, float coefficient_10000);
